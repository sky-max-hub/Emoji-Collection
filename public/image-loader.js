// 图片加载模块
class ImageLoader {
    constructor(galleryElement, galleryContainerElement, dataLoader) {
        this.galleryElement = galleryElement;
        this.galleryContainerElement = galleryContainerElement;
    ...
    setGalleryMarginTop() {
        const headerHeight = document.querySelector('header').offsetHeight;
        this.galleryContainerElement.style.marginTop = `${headerHeight + 20}px`;
    }
